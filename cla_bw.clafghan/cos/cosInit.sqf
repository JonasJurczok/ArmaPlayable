...
COS_distance=8000;//Set spawn distance
_aerielActivation=true;// Set if flying units can activate civilian Zones

blackListTowns = ["Mini Al Malak","Yanotabir","Demenazhir", "Kenykmheni", "Marmakur", "Ovallestan", "Lolosalam", "Alkhemora", "Machifazar", "Spetzyahir","Prozakhar","Mandingara","AlJebel","AlRiyal","Hysad","Alkhemora","Guyosabir","Etnikora","Al_Jebel","Al_Riyal","Gonzalabad","Fareldraguz","Sulakhira","Agresoran","Scarzirah","Ovallestan","Kepsora","Lotohafaz"];// Remove towns from COS

whiteListMkrs=["civplace1","civplace2","civplace3","civplace4"];// Add Custom Markers for COS to populate 
...
COSmaxGrps=40;//Set Maximum group limit for COS at any one time (If limit is hit then civilians will be placed into a single group for each town)
